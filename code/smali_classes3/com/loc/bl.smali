...
.method public constructor <init>(Landroid/content/Context;Lcom/loc/v;)V
    ...
    :cond_0
    iput-object p2, p0, Lcom/loc/bl;->b:Lcom/loc/v;
...
.method private m()[B
    ...
    invoke-virtual {p0}, Lcom/loc/bl;->g()Z
    ...
    iget-object v5, p0, Lcom/loc/bl;->a:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/loc/bl;->i()Z

    move-result v7

    invoke-static {v5, v7}, Lcom/loc/n;->a(Landroid/content/Context;Z)[B

    move-result-object v5

    invoke-static {v5}, Lcom/loc/bl;->a([B)[B
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/loc/bl;->f()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lcom/loc/w;->a(Ljava/lang/String;)[B
    ...
    invoke-static {v5, v1, v6}, Lcom/loc/ag;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_3
...
.method private n()[B
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/loc/bl;->a_()[B
    ...
    :try_start_4
    invoke-static {v5, v1, v0}, Lcom/loc/ag;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_4
...
.method private o()[B
    ...
    invoke-static {v5}, Lcom/loc/q;->a([B)[B
...
.method public b_()Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/loc/bl;->a:Landroid/content/Context;
...
.method public final d()[B
    ...
    :try_start_0
    invoke-static {}, Lcom/loc/bl;->l()[B

    move-result-object v3

    invoke-virtual {v2, v3}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-direct {p0}, Lcom/loc/bl;->m()[B

    move-result-object v3

    invoke-virtual {v2, v3}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-direct {p0}, Lcom/loc/bl;->n()[B

    move-result-object v3

    invoke-virtual {v2, v3}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-direct {p0}, Lcom/loc/bl;->o()[B
...
.method public h()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/loc/bl;->b:Lcom/loc/v;

    invoke-virtual {v1}, Lcom/loc/v;->c()Ljava/lang/String;
