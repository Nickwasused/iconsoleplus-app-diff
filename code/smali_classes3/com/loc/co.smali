...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/loc/co;->b:J

    iput-wide v1, p0, Lcom/loc/co;->c:J

    const/4 v3, 0x1

    iput-boolean v3, p0, Lcom/loc/co;->h:Z

    const/4 v3, 0x0

    iput v3, p0, Lcom/loc/co;->d:I

    iput-wide v1, p0, Lcom/loc/co;->e:J

    iput-object v0, p0, Lcom/loc/co;->f:Lcom/amap/api/location/AMapLocation;

    iput-wide v1, p0, Lcom/loc/co;->g:J
...
.method private b(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    iget-boolean v0, p0, Lcom/loc/co;->h:Z
    ...
    invoke-static {v0, v1}, Lcom/loc/df;->b(J)Z
...
.method public final a(Lcom/amap/api/location/AMapLocation;)Lcom/amap/api/location/AMapLocation;
    ...
    iget-wide v2, p0, Lcom/loc/co;->g:J
    ...
    iput-wide v2, p0, Lcom/loc/co;->g:J
    ...
    :cond_1
    iget-object v0, p0, Lcom/loc/co;->f:Lcom/amap/api/location/AMapLocation;

    if-nez v0, :cond_2

    iput-object p1, p0, Lcom/loc/co;->f:Lcom/amap/api/location/AMapLocation;
    ...
    iget-object v2, p0, Lcom/loc/co;->f:Lcom/amap/api/location/AMapLocation;
    ...
    invoke-static {p1, v0}, Lcom/loc/dp;->a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)F

    move-result v0

    const/high16 v1, 0x40000000    # 2.0f

    iget-object v3, p0, Lcom/loc/co;->f:Lcom/amap/api/location/AMapLocation;
    ...
    iget-object p1, p0, Lcom/loc/co;->f:Lcom/amap/api/location/AMapLocation;
...
.method public final a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    iget-wide v4, v0, Lcom/loc/co;->e:J
    ...
    iput-object v1, v0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    iget-object v1, v0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    iput-wide v2, v0, Lcom/loc/co;->e:J

    iget-object v2, v0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;

    invoke-static {v2}, Lcom/loc/dp;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z

    move-result v2

    if-eqz v2, :cond_13

    invoke-static/range {p1 .. p1}, Lcom/loc/dp;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    iget-object v6, v0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    iput-wide v2, v0, Lcom/loc/co;->b:J
    ...
    invoke-virtual {v6}, Lcom/autonavi/aps/amapapi/model/AMapLocationServer;->c()I
    ...
    iput v2, v0, Lcom/loc/co;->d:I

    iget-object v2, v0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;

    invoke-static {v1, v2}, Lcom/loc/dp;->a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)F
    ...
    iget-wide v11, v0, Lcom/loc/co;->b:J
    ...
    iput-wide v9, v0, Lcom/loc/co;->b:J

    iput-object v1, v0, Lcom/loc/co;->a:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;

    iput-wide v4, v0, Lcom/loc/co;->c:J
    ...
    invoke-direct {v0, v1}, Lcom/loc/co;->b(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    :cond_10
    :goto_2
    iget-wide v2, v0, Lcom/loc/co;->c:J

    cmp-long v6, v2, v4

    if-nez v6, :cond_11

    iput-wide v9, v0, Lcom/loc/co;->c:J
