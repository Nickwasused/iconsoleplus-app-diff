.class public Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd;
...
.method public compactRequestData()Lokio/Buffer;
    ...
    .line 20
    iget-object v0, p0, Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd;->commandData:Lokio/Buffer;
    ...
    .line 22
    invoke-virtual {p0}, Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd;->encodeCommandData()V
...
.method public handleReceivedData([BLchangyow/ble4th/BLEPeripheral;Lchangyow/ble4th/BLEPeripheralListener;)V
    ...
    .line 32
    invoke-virtual {p0, p1}, Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd;->decodeCommandBytes([B)[B
    ...
    invoke-virtual {p0, p1}, Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd;->toInteger(B)I
    ...
    .line 37
    new-instance p2, Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd$1;

    invoke-direct {p2, p0, p3, p1}, Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd$1;-><init>(Lchangyow/ble4th/handler/ski/SKGetMaxLevelCmd;Lchangyow/ble4th/BLEPeripheralListener;I)V
