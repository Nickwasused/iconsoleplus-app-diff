.class public Lchangyow/ble4th/handler/ibiking/IBGetPulseStateCmd;
.super Lchangyow/ble4th/handler/CommandHandler;
.source "IBGetPulseStateCmd.java"
...
.method public compactRequestData()Lokio/Buffer;
    ...
    .line 16
    iget-object v0, p0, Lchangyow/ble4th/handler/ibiking/IBGetPulseStateCmd;->commandData:Lokio/Buffer;
...
.method public handleReceivedData([BLchangyow/ble4th/BLEPeripheral;Lchangyow/ble4th/BLEPeripheralListener;)V
    ...
    :goto_0
    invoke-virtual {p2, p3}, Lchangyow/ble4th/WorkoutStatus;->setIBikingHasPulse(Z)V
