.class final Lcom/amap/api/mapcore/util/jb$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/amap/api/mapcore/util/jb;->a(Landroid/content/Context;)V
.end annotation
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 125
    iput-object p1, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;
...
.method public run()V
    ...
    .line 131
    iget-object v1, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;

    sget-object v3, Lcom/amap/api/mapcore/util/gz;->h:Ljava/lang/String;

    sget v4, Lcom/amap/api/mapcore/util/jb;->a:I
    ...
    .line 134
    new-instance v5, Lcom/amap/api/mapcore/util/gr;
    ...
    invoke-direct {v5, v1}, Lcom/amap/api/mapcore/util/gr;-><init>(Lcom/amap/api/mapcore/util/gs;)V

    .line 136
    new-instance v1, Lcom/amap/api/mapcore/util/ji;

    new-instance v8, Lcom/amap/api/mapcore/util/jh;

    iget-object v3, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;

    new-instance v4, Lcom/amap/api/mapcore/util/jm;

    invoke-direct {v4}, Lcom/amap/api/mapcore/util/jm;-><init>()V
    ...
    .line 138
    invoke-static {v2}, Lcom/amap/api/mapcore/util/gw;->a(I)[B
    ...
    iget-object v10, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;
    ...
    iget-object v9, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/amap/api/mapcore/util/jh;-><init>(Landroid/content/Context;Lcom/amap/api/mapcore/util/jl;Lcom/amap/api/mapcore/util/gs;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-direct {v1, v8}, Lcom/amap/api/mapcore/util/ji;-><init>(Lcom/amap/api/mapcore/util/jl;)V
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;

    iget v3, v0, Lcom/amap/api/mapcore/util/ix;->h:I

    iget-object v4, v0, Lcom/amap/api/mapcore/util/ix;->i:Ljava/lang/String;

    new-instance v5, Lcom/amap/api/mapcore/util/jo;

    iget-object v6, p0, Lcom/amap/api/mapcore/util/jb$2;->a:Landroid/content/Context;

    sget-boolean v7, Lcom/amap/api/mapcore/util/jb;->b:Z

    .line 153
    invoke-static {}, Lcom/amap/api/mapcore/util/jb;->b()I

    move-result v8

    mul-int/lit16 v8, v8, 0x400

    sget v9, Lcom/amap/api/mapcore/util/jb;->c:I

    mul-int/lit16 v9, v9, 0x400

    invoke-direct {v5, v6, v7, v8, v9}, Lcom/amap/api/mapcore/util/jo;-><init>(Landroid/content/Context;ZII)V
