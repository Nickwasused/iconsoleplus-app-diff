...
.method private k()V
    ...
    .line 225
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->e:Landroid/widget/ListView;
...
.method public a()V
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->d:Lcom/amap/api/maps/offlinemap/DownLoadExpandListView;

    .line 84
    invoke-virtual {v1, p0}, Lcom/amap/api/maps/offlinemap/DownLoadExpandListView;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->j:Landroid/widget/RelativeLayout;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->g:Landroid/widget/ImageView;

    .line 87
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->j:Landroid/widget/RelativeLayout;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->k:Landroid/widget/RelativeLayout;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->h:Landroid/widget/ImageView;

    .line 90
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->k:Landroid/widget/RelativeLayout;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->n:Landroid/widget/RelativeLayout;

    .line 94
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->c:Landroid/widget/RelativeLayout;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->b:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->m:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->l:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->i:Landroid/widget/AutoCompleteTextView;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->e:Landroid/widget/ListView;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/fq;->f:Landroid/widget/ExpandableListView;
    ...
    invoke-direct {v0, v1, v3, v4}, Lcom/amap/api/mapcore/util/fk;-><init>(Ljava/util/List;Lcom/amap/api/maps/offlinemap/OfflineMapManager;Landroid/content/Context;)V

    iput-object v0, p0, Lcom/amap/api/mapcore/util/fq;->p:Lcom/amap/api/mapcore/util/fk;

    .line 133
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->f:Landroid/widget/ExpandableListView;
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->p:Lcom/amap/api/mapcore/util/fk;
...
.method public i()V
    ...
    .line 233
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fq;->d:Lcom/amap/api/maps/offlinemap/DownLoadExpandListView;

    invoke-virtual {v1, v0}, Lcom/amap/api/maps/offlinemap/DownLoadExpandListView;->setAdapter(Landroid/widget/ExpandableListAdapter;)V
