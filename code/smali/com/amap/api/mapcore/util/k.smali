...
.method private a(Landroid/content/Context;Lcom/amap/api/mapcore/util/gn;Lcom/amap/api/mapcore/util/gd$a;)V
    ...
    invoke-static/range {v2 .. v8}, Lcom/amap/api/mapcore/util/ia;->a(Lcom/amap/api/mapcore/util/gn;Ljava/lang/String;Ljava/lang/String;ZZZLjava/lang/String;)Lcom/amap/api/mapcore/util/ia;

    move-result-object p1

    .line 476
    invoke-static {p2}, Lcom/amap/api/mapcore/util/hz;->a(Lcom/amap/api/mapcore/util/gn;)Lcom/amap/api/mapcore/util/hz;
    ...
    invoke-virtual {p2, v0, p1, p3, v9}, Lcom/amap/api/mapcore/util/hz;->a(Landroid/content/Context;Lcom/amap/api/mapcore/util/ia;ZZ)V
    :try_end_0
...
.method private a(Lcom/amap/api/mapcore/util/gd$a;)V
    ...
    .line 540
    invoke-static {v1, p1}, Lcom/amap/api/mapcore/util/jb;->a(IZ)V
...
.method private b(Landroid/content/Context;Lcom/amap/api/mapcore/util/gn;Lcom/amap/api/mapcore/util/gd$a;)V
    ...
    invoke-virtual {p2, p1, v2, p3}, Lcom/amap/api/mapcore/util/hz;->a(Landroid/content/Context;ZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public run()V
    ...
    .line 320
    :cond_c
    new-instance v5, Lcom/amap/api/mapcore/util/hm;

    invoke-virtual {v9}, Lcom/amap/api/mapcore/util/gd$a;->a()Z

    move-result v6

    invoke-direct {v5, v2, v1, v0, v6}, Lcom/amap/api/mapcore/util/hm;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {v0, v1, v5, v2}, Lcom/amap/api/mapcore/util/hl;-><init>(Landroid/content/Context;Lcom/amap/api/mapcore/util/hm;Lcom/amap/api/mapcore/util/gn;)V

    .line 322
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/hl;->a()V
    ...
    invoke-direct {v0, v1, v12, v2}, Lcom/amap/api/mapcore/util/hl;-><init>(Landroid/content/Context;Lcom/amap/api/mapcore/util/hm;Lcom/amap/api/mapcore/util/gn;)V
    ...
    invoke-static {v0, v1}, Lcom/amap/api/mapcore/util/hb;->a(Landroid/content/Context;Lcom/amap/api/mapcore/util/gn;)Lcom/amap/api/mapcore/util/hb;
