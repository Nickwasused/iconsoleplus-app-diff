...
# instance fields
.field private final m:Lcom/amap/api/mapcore/util/al$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/api/mapcore/util/al;->l:Landroid/graphics/PointF;
...
.method public constructor <init>(Landroid/content/Context;Lcom/amap/api/mapcore/util/al$a;)V
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/util/al;->q:Landroid/graphics/PointF;
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/util/al;->r:Landroid/graphics/PointF;

    .line 52
    iput-object p2, p0, Lcom/amap/api/mapcore/util/al;->m:Lcom/amap/api/mapcore/util/al$a;
...
.method protected a()V
    ...
    .line 145
    iput-boolean v0, p0, Lcom/amap/api/mapcore/util/al;->n:Z
...
.method protected a(ILandroid/view/MotionEvent;)V
    ...
    .line 108
    iget-boolean p1, p0, Lcom/amap/api/mapcore/util/al;->n:Z

    if-nez p1, :cond_1

    .line 109
    iget-object p1, p0, Lcom/amap/api/mapcore/util/al;->m:Lcom/amap/api/mapcore/util/al$a;
...
.method protected a(ILandroid/view/MotionEvent;II)V
    ...
    iput-boolean p1, p0, Lcom/amap/api/mapcore/util/al;->n:Z
...
.method protected a(Landroid/view/MotionEvent;)V
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/util/al;->o:Landroid/graphics/PointF;
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/al;->p:Landroid/graphics/PointF;
    ...
    .line 163
    sget-object p1, Lcom/amap/api/mapcore/util/al;->l:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/util/al;->o:Landroid/graphics/PointF;

    iget v0, v0, Landroid/graphics/PointF;->x:F

    iget-object v1, p0, Lcom/amap/api/mapcore/util/al;->p:Landroid/graphics/PointF;

    iget v1, v1, Landroid/graphics/PointF;->x:F

    sub-float/2addr v0, v1

    iget-object v1, p0, Lcom/amap/api/mapcore/util/al;->o:Landroid/graphics/PointF;

    iget v1, v1, Landroid/graphics/PointF;->y:F

    iget-object v2, p0, Lcom/amap/api/mapcore/util/al;->p:Landroid/graphics/PointF;
    ...
    .line 169
    iget-object p1, p0, Lcom/amap/api/mapcore/util/al;->q:Landroid/graphics/PointF;
...
.method public d()Landroid/graphics/PointF;
    ...
    .line 183
    iget-object v0, p0, Lcom/amap/api/mapcore/util/al;->r:Landroid/graphics/PointF;
