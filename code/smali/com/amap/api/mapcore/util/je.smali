.class public Lcom/amap/api/mapcore/util/je;
.super Ljava/lang/Object;
.source "Utils.java"


# direct methods
.method public static a(Ljava/lang/ref/WeakReference;)Lcom/amap/api/mapcore/util/ix;
    .locals 1
    ...
    invoke-direct {v0}, Lcom/amap/api/mapcore/util/ix;-><init>()V
    ...
    check-cast p0, Lcom/amap/api/mapcore/util/ix;
...
.method public static a(Landroid/content/Context;Lcom/amap/api/mapcore/util/ix;Ljava/lang/String;IILjava/lang/String;)V
    .locals 0

    .line 20
    invoke-static {p0, p2}, Lcom/amap/api/mapcore/util/gz;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    iput-object p0, p1, Lcom/amap/api/mapcore/util/ix;->a:Ljava/lang/String;

    .line 21
    iput p3, p1, Lcom/amap/api/mapcore/util/ix;->d:I

    int-to-long p2, p4

    .line 22
    iput-wide p2, p1, Lcom/amap/api/mapcore/util/ix;->b:J

    .line 23
    iput-object p5, p1, Lcom/amap/api/mapcore/util/ix;->c:Ljava/lang/String;

    return-void
.end method

.method static a(Lcom/amap/api/mapcore/util/ii;Ljava/lang/String;Z)[B
    .locals 4
    ...
    .line 40
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/amap/api/mapcore/util/ii;->a(Ljava/lang/String;)Lcom/amap/api/mapcore/util/ii$b;
    ...
    .line 67
    :try_start_1
    invoke-virtual {v3}, Lcom/amap/api/mapcore/util/ii$b;->close()V
    :try_end_1
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v3, v0}, Lcom/amap/api/mapcore/util/ii$b;->a(I)Ljava/io/InputStream;
    ...
    .line 52
    invoke-virtual {p0, p1}, Lcom/amap/api/mapcore/util/ii;->c(Ljava/lang/String;)Z
    :try_end_5
